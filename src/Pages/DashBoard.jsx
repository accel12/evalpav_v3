    ...
    <div className=" px-5 text-white pb-2" style={{ minWidth: "1280px" }}>
      <div className="bg-fondoAlterno rounded-3xl w-full min-w-[720px]  scroll-smooth">
        <div className="flex justify-center items-center">
          <div
            className=" flex items-center justify-center space-x-8  py-3 flex-wrap"
          ...
          >
            ...
            <div className="flex items-center my-4">
              ...
              <label className="pr-8 pl-2 bg-fondoTextoAlterno rounded-md text-black border border-black">
                {valorActual.length == 0 ? 0 : valorActual[0].Carril}
              </label>
            </div>
            <div className="flex items-center my-4">
            ...
            <div className="flex items-center my-4">
              ...
              <input
                className="pr-8 pl-2 bg-fondoTextoAlterno rounded-md text-black border border-black"
                onChange={(e) => {
                  setProgresivaBuscar(e.target.value);
                }}
              ></input>
              <button
                className="ml-2 text-white bg-azul hover:bg-botonPresionado focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-1.5 text-center inline-flex items-center"
                onClick={buscarProgresiva}
              >
        ...
        <div className="flex mb-6 bg-fondoPanel py-2 border-b border-black">
          <div className="h-6 flex items-center ">
            <button style={{ height: 25, width: 25 }}>
              <img
                src={Menos}
            ...
            <label className="pr-8 pl-2 mr-4 bg-white text-black">
              {indice + 1}
            </label>
